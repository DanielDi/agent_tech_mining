...
few_shot_examples = [
    {
        "Document": "Mapping the evolution of seawater desalination research",
        "AnalyzedFields": "Title; Abstract; Keywords",
        "TermPreprocessing": "Thesaurus grouping; Exclude countries and location terms",
        "Clustering": "SciMAT",
        "ClusterAnalysis": "Connection analysis; Frequency analysis; Evolution analysis; Most cited articles",
        "PaperCount": "11,942 (2000–2024)",
        "TermCount": "500 terms"
    },
    {
        "Document": "Knowledge-map and research trends of circulating tumor cells",
        "AnalyzedFields": "Keywords",
        "TermPreprocessing": "Not specified",
        "Clustering": "VOSviewer; CiteSpace; gCLUTO",
        "ClusterAnalysis": "Theme identification; Influential author analysis; Connection analysis",
...
def main():
    parser = argparse.ArgumentParser(
        description="Process PDFs and save metadata to Excel, replacing entries for existing files."
    )
    parser.add_argument("input", help="Path to PDF file or directory")
    parser.add_argument(
        "--excel", default="metadata.xlsx",
        help="Output Excel file path (default: metadata.xlsx)"
    )
